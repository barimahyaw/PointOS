...
{
    public class SalesAdapter : DataAdaptor
    {
        private readonly IApiEndpointCallService _apiEndpointCallService;
        private readonly ISessionStorageService _sessionStorageService;

        public SalesAdapter(IApiEndpointCallService apiEndpointCallService, ISessionStorageService sessionStorageService)
        {
        ...
        public override async Task<object> ReadAsync(DataManagerRequest dataManagerRequest, string key = null)
        {
            ...
            var response = await _apiEndpointCallService.CallApiGetService("Sales/GetByCompany", null, param);

            var result = JsonConvert.DeserializeObject<ListResponse<SalesResponse>>(response.ToString());
