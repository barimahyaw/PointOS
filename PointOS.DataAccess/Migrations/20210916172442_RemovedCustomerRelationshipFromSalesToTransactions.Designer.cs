...
namespace PointOS.DataAccess.Migrations
{
    ...
    [Migration("20210916172442_RemovedCustomerRelationshipFromSalesToTransactions")]
    partial class RemovedCustomerRelationshipFromSalesToTransactions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.Currency", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("CreatedUerId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ModifiedUerId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CreatedUerId");

                    b.HasIndex("ModifiedUerId");
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.ProductStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.Customer", b =>
                {
                    b.HasOne("PointOS.DataAccess.Entities.ApplicationUser", "CreatedUer")
                        .WithMany()
                        .HasForeignKey("CreatedUerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PointOS.DataAccess.Entities.ApplicationUser", "ModifiedUer")
                        .WithMany()
                        .HasForeignKey("ModifiedUerId");

                    b.Navigation("CreatedUer");

                    b.Navigation("ModifiedUer");
                });
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.ProductPricing", b =>
                {
                    ...
                    b.HasOne("PointOS.DataAccess.Entities.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.Transactions", b =>
                {
                    ...
                    b.HasOne("PointOS.DataAccess.Entities.Customer", "Customer")
                        .WithMany("Sales")
                        .HasForeignKey("CustomerId");

                    b.HasOne("PointOS.DataAccess.Entities.ProductPricing", null)
