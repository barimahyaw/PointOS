...
namespace PointOS.DataAccess.Migrations
{
    ...
    [Migration("20210429151729_SalesAndPaymentTypeDbSetCreated")]
    partial class SalesAndPaymentTypeDbSetCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.Sales", b =>
                {
                    ...
                    b.HasOne("PointOS.DataAccess.Entities.PaymentType", "PaymentType")
                        .WithMany("Sales")
            ...
            modelBuilder.Entity("PointOS.DataAccess.Entities.Transactions", b =>
                {
                    ...
                    b.HasOne("PointOS.DataAccess.Entities.TransactionType", "TransactionType")
                        .WithMany()
